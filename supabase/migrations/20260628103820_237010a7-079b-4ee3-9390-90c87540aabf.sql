...
-- Auto-grant admin to the owner email once their email is verified
...
BEGIN
  IF NEW.email_confirmed_at IS NOT NULL
     AND lower(NEW.email) = 'my.lifeafterlaw@gmail.com' THEN
...
-- Admins can view the email send log
